...
parser.add_option("-r", "--reference", dest="reference", help="Reference genome to perform reference check (fasta index needs to be available) (def %s/reference/reference.fa)" %
                  (ROOTanno), default='%s/reference/reference.fa' % (ROOTanno))
