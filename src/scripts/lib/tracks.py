...
'relfreq1': {
    ...
    'type': float,
    'dependencies': ['bravofreq100', 'bravofreq1000'],
    'derive': lambda x: math.log10(float(x['bravofreq100']) / float(x['bravofreq1000'])),
    'na_value': -0.5
    },
'relfreq2': {
    'description': 'Log10 of relative frequency of frequent variants in 100 and 10000 bp window',
    'type': float,
    'dependencies': ['bravofreq100', 'bravofreq10000'],
    'derive': lambda x: math.log10(float(x['bravofreq100']) / float(x['bravofreq10000'])),
    'na_value': -1.5
    },
'relfreq3': {
    'description': 'Log10 of relative frequency of frequent variants in 1000 and 10000 bp window',
    'type': float,
    'dependencies': ['bravofreq1000', 'bravofreq10000'],
    'derive': lambda x: math.log10(float(x['bravofreq1000']) / float(x['bravofreq10000'])),
    'na_value': -1
    },
'relrare1': {
    'description': 'Log10 of relative frequency of rare variants in 100 and 1000 bp window',
    'type': float,
    'dependencies': ['bravorare100', 'bravorare1000'],
    'derive': lambda x: math.log10(float(x['bravorare100']) / float(x['bravorare1000'])),
    'na_value': -1
    },
'relrare2': {
    'description': 'Log10 of relative frequency of rare variants in 100 and 10000 bp window',
    'type': float,
    'dependencies': ['bravorare100', 'bravorare10000'],
    'derive': lambda x: math.log10(float(x['bravorare100']) / float(x['bravorare10000'])),
    'na_value': -2
    },
'relrare3': {
    'description': 'Log10 of relative frequency of rare variants in 1000 and 10000 bp window',
    'type': float,
    'dependencies': ['bravorare1000', 'bravorare10000'],
    'derive': lambda x: math.log10(float(x['bravorare1000']) / float(x['bravorare10000'])),
    'na_value': -1
    },
'relsngl1': {
    'description': 'Log10 of relative frequency of single occurance variants in 100 and 1000 bp window',
    'type': float,
    'dependencies': ['bravosngl100', 'bravosngl1000'],
    'derive': lambda x: math.log10(float(x['bravosngl100']) / float(x['bravosngl1000'])),
    'na_value': -1
    },
'relsngl2': {
    'description': 'Log10 of relative frequency of single occurance variants in 100 and 10000 bp window',
    'type': float,
    'dependencies': ['bravosngl100', 'bravosngl10000'],
    'derive': lambda x: math.log10(float(x['bravosngl100']) / float(x['bravosngl10000'])),
    'na_value': -2
    },
'relsngl3': {
    'description': 'Log10 of relative frequency of single occurance variants in 1000 and 10000 bp window',
    'type': float,
    'dependencies': ['bravosngl1000', 'bravosngl10000'],
